...
| 5 | Notificaciones geográficas | ⚠️ Incompleta — envíos OK (200 en prod), pero el SDK no suscribe navegadores (suscripción sin token push); conflicto de service worker con Serwist por resolver |
